...
# Affichage du menu pour le choix du nombre de joueur
def afficher_menu_nb_joueur(fenetre):
    ...
    # Création des boutons pour choisir le nombre de joueur
    ...
    # Attente du choix du nombre de joueur
    nb_joueur = 0
    while nb_joueur == 0:
...
# ffichage du menu pour le choix de la taille du plateau
def afficher_menu_taille_plateau(fenetre):
    ...
    # Création des boutons pour choisir la taille du plateau
    ...
    # Attente du choix de la taille du plateau
    taille_plateau = 0
